package one.digitalinovatio.laboojava.console;

import one.digitalinovatio.laboojava.basedados.Banco;
import one.digitalinovatio.laboojava.entidade.*;
import one.digitalinovatio.laboojava.negocio.ClienteNegocio;
import one.digitalinovatio.laboojava.negocio.PedidoNegocio;
import one.digitalinovatio.laboojava.negocio.ProdutoNegocio;
import one.digitalinovatio.laboojava.utilidade.LeitoraDados;
